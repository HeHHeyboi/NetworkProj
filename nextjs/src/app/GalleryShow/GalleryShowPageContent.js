...
// Component for displaying each gallery item
    ...
    return (
        <div className="border p-4 rounded-lg shadow-sm">
            ...
            <p className="text-gray-600">
                <strong>Start Date:</strong> {gallery.start_date}
            </p>
            <p className="text-gray-600">
                <strong>End Date:</strong> {gallery.end_date}
            </p>
        </div>
    );
};

export default function GalleryShowPageContent() {
